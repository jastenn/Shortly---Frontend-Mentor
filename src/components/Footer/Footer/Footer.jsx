...
const Footer = ({features, resources, company}) => {
    
    return (
        <footer className="footer__main">
            <div className="container footer-flex">
                <svg className="footer__logo" xmlns="http://www.w3.org/2000/svg" width="121" height="33">
                ...
                <ul className="footer__navlist">
                    <li className="navlist">
                        <h3 className="navlist__header">Features</h3>
                        <ul className="navlist__items">
                            {features.map(feature => {
                                return (
                                    <li className="navlist__item" key={feature.id}>{
                                        // eslint-disable-next-line
                                    }   <a className="navlist__link" href={feature.link}>{feature.value}</a>
                                    </li>
                                )
                            })}
                        </ul>
                    ...
                    <li className="navlist">
                        <h3 className="navlist__header">Resources</h3>
                        <ul className="navlist__items">
                            {resources.map(curResource => {
                                return (
                                    <li className="navlist__item" key={curResource.id}>{
                                        // eslint-disable-next-line
                                    }   <a className="navlist__link" href={curResource.link}>{curResource.value}</a>
                                    </li>
                                )
                            })}
                        </ul>
                    ...
                    <li className="navlist">
                        <h3 className="navlist__header">Company</h3>
                        <ul className="navlist__items">
                            {company.map(curCompany => {
                                return (
                                    <li className="navlist__item" key={curCompany.id}>{
                                        // eslint-disable-next-line
                                    }   <a className="navlist__link" href={curCompany.link}>{curCompany.value}</a>
                                    </li>
                                )
                            })}
                        </ul>
...
Footer.defaultProps = {
    features: [
        {id: 1, value: 'Link Shortening', link: '#'},
        {id: 2, value: 'Branded Links', link: '#'},
        {id: 3, value: 'Analytics', link: '#'},
    ],
    resources: [
        {id: 1, value: 'Blog', link: '#'},
        {id: 2, value: 'Developers', link: '#'},
        {id: 3, value: 'Supports', link: '#'},
    ],
    company: [
        {id: 1, value: 'About', link: '#'},
        {id: 2, value: 'Our Team', link: '#'},
        {id: 3, value: 'Careers', link: '#'},
        {id: 4, value: 'Contact', link: '#'},
    ],
}
